...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <section className="banner-container my-10 flex justify-center">
        <div className="relative w-full aspect-[16/5] rounded-xl overflow-hidden shadow-lg transition-transform duration-300 ease-in-out hover:scale-102">
          <Image
