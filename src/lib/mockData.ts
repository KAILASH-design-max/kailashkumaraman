...
export const mockProducts: Product[] = [
  ...
  { id: 'prod5', slug: 'sliced-bread', name: 'Sliced Bread (Whole Wheat)', description: 'Soft whole wheat sliced bread.', price: 52, category: 'cat6', imageUrls: [{url: 'https://placehold.co/400x300.png', dataAiHint: 'bread loaf'}], dataAiHint: 'bread loaf', stock: 60 },
  ...
  { id: 'prod15', slug: 'cherry-tomatoes', name: 'Cherry Tomatoes', description: 'Sweet and juicy cherry tomatoes, perfect for salads.', price: 25, category: 'cat2', imageUrls: [{url: 'https://freepngimg.com/thumb/tomato/1-tomato-png-image.png', dataAiHint: 'red tomatoes'}], dataAiHint: 'red tomatoes', rating: 4.5, reviewsCount: 80, stock: 45 },
  ...
  { id: 'prod17', slug: 'potatoes', name: 'Potatoes', description: 'Versatile potatoes, ideal for mashing, baking, or frying.', price: 29, category: 'cat2', imageUrls: [{url: 'https://freepngimg.com/thumb/potato/11-2-potato-transparent.png', dataAiHint: 'brown potatoes'}], dataAiHint: 'brown potatoes', rating: 4.3, reviewsCount: 110, stock: 70 },
  ...
  { id: 'prod19', slug: 'cucumber', name: 'Cucumber', description: 'Cool and crisp cucumber, great for salads and hydration.', price: 33, category: 'cat2', imageUrls: [{url: 'https://freepngimg.com/thumb/cucumber/20-cucumbers-png-image.png', dataAiHint: 'green cucumber'}], dataAiHint: 'green cucumber', rating: 4.4, reviewsCount: 60, stock: 55 },
  ...
  { id: 'prod32', slug: 'baby-wipes', name: 'Baby Wipes (Sensitive)', description: 'Gentle baby wipes for sensitive skin.', price: 205, category: 'cat14', imageUrls: [{url: 'https://placehold.co/400x300.png', dataAiHint: 'wipes pack'}], dataAiHint: 'wipes pack', rating: 4.9, reviewsCount: 110, stock: 70 },
  ...
  { id: 'prod34', slug: 'laundry-detergent', name: 'Laundry Detergent (1L)', description: 'Powerful laundry detergent.', price: 144, category: 'cat16', imageUrls: [{url: 'https://placehold.co/400x300.png', dataAiHint: 'detergent bottle'}], dataAiHint: 'detergent bottle', rating: 4.6, reviewsCount: 90, stock: 0 },
  ...
  { id: 'prod37', slug: 'dog-food-dry', name: 'Dog Food (Dry, 1kg)', description: 'Nutritious dry dog food.', price: 40, category: 'cat19', imageUrls: [{url: 'https://placehold.co/400x300.png', dataAiHint: 'dog food'}], dataAiHint: 'dog food', rating: 4.8, reviewsCount: 75, stock: 45 },
  ...
  { id: 'prod44', slug: 'mccain-frozen-french-fries-500g', name: 'McCain Frozen French Fries – Crispy Potato Snack – 500g Pack', description: 'Classic McCain french fries, ready to fry for a crispy snack.', price: 128, category: 'cat5', imageUrls: [{url: 'https://banner2.cleanpng.com/20180319/gwe/kisspng-french-fries-potato-frying-deep-frying-frozen-fren-potato-fries-5ab031d21d4000.2829797615214953788307.jpg', dataAiHint: 'french fries'}], dataAiHint: 'french fries', rating: 4.7, reviewsCount: 180, stock: 90 },
  { id: 'prod45', slug: 'coca-cola', name: 'Coca-Cola', description: 'Classic Coca-Cola soft drink.', price: 40, category: 'cat4', imageUrls: [{url: 'https://banner2.cleanpng.com/20180704/ufz/aawf7csvs.webp', dataAiHint: 'cola soda'}], dataAiHint: 'cola soda', rating: 4.8, reviewsCount: 500, stock: 150 },
  ...
  { id: 'prod47', slug: 'sprite', name: 'Sprite', description: 'Crisp lemon-lime flavored Sprite.', price: 40, category: 'cat4', imageUrls: [{url: 'https://banner2.cleanpng.com/20180201/uoq/av2mm4bo6.webp', dataAiHint: 'sprite soda'}], dataAiHint: 'sprite soda', rating: 4.6, reviewsCount: 400, stock: 130 },
  ...
  },
  {
  ...
  },
   {
    ...
    items: [
      ...
      { productId: 'prod5', name: 'Sliced Bread (Whole Wheat)', quantity: 1, price: 52 }, // Price updated
    ],
    totalAmount: 53.99, // Recalculated: 1.99 + 52
    status: 'Confirmed',
