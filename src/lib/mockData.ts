...
export const mockProducts: Product[] = [
  { id: 'prod1', name: 'Apples (Shimla)', description: 'Crisp and juicy red apples from Shimla, perfect for snacking or baking.', price: 120, category: 'cat2',
    images: ['https://placehold.co/600x450/E74C3C/ffffff.png'],
    rating: 4.5, reviewsCount: 120, stock: 50, status: 'active',
  ...
  { id: 'prod2', name: 'Bananas (Robusta)', description: 'Sweet and ripe Robusta bananas.', price: 40, category: 'cat2',
    images: ['https://placehold.co/600x450/F1C40F/000000.png'],
    rating: 4.7, reviewsCount: 90, stock: 30, status: 'active',
  ...
  { id: 'prod3', name: 'Fresh Carrots (Local)', description: 'Fresh, crunchy local carrots.', price: 30, category: 'cat2',
    images: ['https://placehold.co/600x450/E67E22/ffffff.png'],
    stock: 100, status: 'active', rating: 4.3, reviewsCount: 50,
  ...
  { id: 'prod4', name: 'Whole Milk (1L)', description: 'Fresh pasteurized whole milk.', price: 65, category: 'cat1',
    images: ['https://placehold.co/600x450/ECF0F1/000000.png'],
    rating: 4.8, reviewsCount: 200, stock: 75, status: 'active',
  ...
  { id: 'prod5', name: 'Zero Maida Whole-Wheat Bread', description: 'Soft whole wheat sliced bread, zero maida.', price: 52, category: 'cat6',
    images: ['https://placehold.co/600x450/F5E1DA/000000.png'],
    stock: 60, status: 'active', rating: 4.6, reviewsCount: 80,
  ...
  { id: 'prod6', name: 'Potato Chips (Salted)', description: 'Classic salted potato chips.', price: 20, category: 'cat5',
    images: ['https://placehold.co/600x450/F9E79F/000000.png'],
    rating: 4.2, reviewsCount: 150, stock: 120, status: 'active',
  ...
  { id: 'prod7', name: 'Cola Drink (2L)', description: 'Refreshing cola beverage.', price: 90, category: 'cat4',
    images: ['https://placehold.co/600x450/A93226/ffffff.png'],
    stock: 80, status: 'active', rating: 4.5, reviewsCount: 100,
  ...
  { id: 'prod8', name: 'Dish Soap (500ml)', description: 'Effective grease-cutting dish soap.', price: 75, category: 'cat16',
    images: ['https://placehold.co/600x450/AED6F1/000000.png'],
    rating: 4.6, reviewsCount: 70, stock: 40, status: 'active',
  ...
  { id: 'prod9', name: 'Toothpaste (Mint)', description: 'Mint flavored toothpaste for fresh breath.', price: 55, category: 'cat18',
    images: ['https://placehold.co/600x450/A2D9CE/000000.png'],
    stock: 90, status: 'active', rating: 4.7, reviewsCount: 90,
  ...
  { id: 'prod10', name: 'Avocado Hass (Single)', description: 'Creamy Hass avocado.', price: 180, category: 'cat2',
    images: ['https://placehold.co/600x450/588157/ffffff.png'],
    rating: 4.9, reviewsCount: 250, stock: 0, status: 'inactive',
  ...
  { id: 'prod11', name: 'Organic Spinach', description: 'Fresh organic spinach leaves, packed with nutrients.', price: 50, category: 'cat2',
    images: ['https://placehold.co/600x450/8FBC8F/000000.png'],
    rating: 4.6, reviewsCount: 55, stock: 40, status: 'active',
  ...
  { id: 'prod12', name: 'Orange (Nagpur)', description: 'Juicy and sweet oranges from Nagpur, rich in Vitamin C.', price: 80, category: 'cat2',
    images: ['https://placehold.co/600x450/FFA500/000000.png'],
    rating: 4.4, reviewsCount: 70, stock: 60, status: 'active',
  ...
  { id: 'prod13', name: 'Broccoli (Organic)', description: 'Fresh organic broccoli head, great for steaming or roasting.', price: 70, category: 'cat2',
    images: ['https://placehold.co/600x450/556B2F/ffffff.png'],
    rating: 4.7, reviewsCount: 65, stock: 35, status: 'active',
  ...
  { id: 'prod14', name: 'Mangoes (Alphonso)', description: 'Sweet and flavorful Alphonso mangoes, the king of mangoes.', price: 500, category: 'cat2',
    images: ['https://placehold.co/600x450/FFBF00/000000.png'],
    rating: 4.9, reviewsCount: 150, stock: 20, status: 'active',
  ...
  { id: 'prod15', name: 'Hybrid Tomato (Tamatar)', description: 'Sweet and juicy hybrid tomatoes, perfect for salads.', price: 25, category: 'cat2',
    images: ['https://placehold.co/600x450/FF6347/ffffff.png'],
    rating: 4.5, reviewsCount: 80, stock: 45, status: 'active',
  ...
  { id: 'prod16', name: 'Pomegranate', description: 'Fresh pomegranate with antioxidant-rich seeds.', price: 110, category: 'cat2',
    images: ['https://placehold.co/600x450/D22B2B/ffffff.png'],
    rating: 4.6, reviewsCount: 90, stock: 25, status: 'active',
  ...
  { id: 'prod17', name: 'Potato (Aloo)', description: 'Versatile potatoes, ideal for mashing, baking, or frying.', price: 29, category: 'cat2',
    images: ['https://placehold.co/600x450/D2B48C/000000.png'],
    rating: 4.3, reviewsCount: 110, stock: 70, status: 'active',
  ...
  { id: 'prod18', name: 'Strawberries (Fresh)', description: 'Sweet, ripe, and fresh strawberries.', price: 150, category: 'cat2',
    images: ['https://placehold.co/600x450/FF69B4/ffffff.png'],
    rating: 4.8, reviewsCount: 100, stock: 30, status: 'active',
  ...
  { id: 'prod19', name: 'English Cucumber (Kheera)', description: 'Cool and crisp cucumber, great for salads and hydration.', price: 33, category: 'cat2',
    images: ['https://placehold.co/600x450/90EE90/000000.png'],
    rating: 4.4, reviewsCount: 60, stock: 55, status: 'active',
  ...
  { id: 'prod20', name: 'Eggs (Dozen)', description: 'Farm fresh brown eggs.', price: 84, category: 'cat1',
    images: ['https://placehold.co/600x450/F5DEB3/000000.png'],
    rating: 4.7, reviewsCount: 180, stock: 50, status: 'active',
  ...
  { id: 'prod21', name: 'Cereal Flakes', description: 'Healthy corn cereal flakes for breakfast.', price: 180, category: 'cat3',
    images: ['https://placehold.co/600x450/FFDAB9/000000.png'],
    rating: 4.5, reviewsCount: 90, stock: 60, status: 'active',
  ...
  { id: 'prod22', name: 'Orange Juice (1L)', description: 'Freshly squeezed orange juice.', price: 110, category: 'cat4',
    images: ['https://placehold.co/600x450/FFEBCD/000000.png'],
    rating: 4.6, reviewsCount: 110, stock: 70, status: 'active',
  ...
  { id: 'prod23', name: 'Chocolate Cookies', description: 'Delicious chocolate chip cookies.', price: 75, category: 'cat5',
    images: ['https://placehold.co/600x450/8B4513/ffffff.png'],
    rating: 4.8, reviewsCount: 130, stock: 80, status: 'active',
  ...
  { id: 'prod24', name: 'Croissants (Pack of 4)', description: 'Buttery and flaky croissants.', price: 160, category: 'cat6',
    images: ['https://placehold.co/600x450/F0E68C/000000.png'],
    rating: 4.9, reviewsCount: 100, stock: 40, status: 'active',
  ...
  { id: 'prod25', name: 'Green Tea Bags (25 count)', description: 'Refreshing green tea bags.', price: 90, category: 'cat7',
    images: ['https://placehold.co/600x450/98FB98/000000.png'],
    rating: 4.7, reviewsCount: 85, stock: 55, status: 'active',
  ...
  { id: 'prod26', name: 'Basmati Rice (1kg)', description: 'Premium long-grain basmati rice.', price: 150, category: 'cat8',
    images: ['https://placehold.co/600x450/FAF0E6/000000.png'],
    rating: 4.9, reviewsCount: 150, stock: 65, status: 'active',
  ...
  { id: 'prod27', name: 'Olive Oil (500ml)', description: 'Extra virgin olive oil.', price: 350, category: 'cat9',
    images: ['https://placehold.co/600x450/BDB76B/000000.png'],
    rating: 4.8, reviewsCount: 120, stock: 30, status: 'active',
  ...
  { id: 'prod28', name: 'Dark Chocolate Bar', description: 'Rich 70% cocoa dark chocolate.', price: 120, category: 'cat10',
    images: ['https://placehold.co/600x450/5C3317/ffffff.png'],
    rating: 4.9, reviewsCount: 200, stock: 90, status: 'active',
  ...
  { id: 'prod29', name: 'Strawberry Jam', description: 'Sweet strawberry jam/preserve.', price: 95, category: 'cat11',
    images: ['https://placehold.co/600x450/FFB6C1/000000.png'],
    rating: 4.6, reviewsCount: 70, stock: 40, status: 'active',
  ...
  { id: 'prod30', name: 'Chicken Breast (500g)', description: 'Fresh boneless chicken breast.', price: 250, category: 'cat12',
    images: ['https://placehold.co/600x450/FFE4E1/000000.png'],
    rating: 4.7, reviewsCount: 95, stock: 25, status: 'active',
  ...
  { id: 'prod31', name: 'Organic Quinoa (500g)', description: 'Healthy organic quinoa grains.', price: 220, category: 'cat13',
    images: ['https://placehold.co/600x450/F0E68C/000000.png'],
    rating: 4.8, reviewsCount: 60, stock: 35, status: 'active',
  ...
  { id: 'prod32', name: 'Mee Mee Aloe Vera Baby Wipes (3×72)', description: 'Gentle baby wipes for sensitive skin.', price: 205, category: 'cat14',
    images: ['https://placehold.co/600x450/E0FFFF/000000.png'],
    rating: 4.9, reviewsCount: 110, stock: 70, status: 'active',
  ...
  { id: 'prod33', name: 'Vitamin C Tablets', description: 'Immune boosting Vitamin C supplements.', price: 150, category: 'cat15',
    images: ['https://placehold.co/600x450/FFE4B5/000000.png'],
    rating: 4.7, reviewsCount: 50, stock: 80, status: 'active',
  ...
  { id: 'prod34', name: 'Surf Excel Easy Wash Detergent Powder (1 kg)', description: 'Powerful laundry detergent.', price: 144, category: 'cat16',
    images: ['https://placehold.co/600x450/ADD8E6/000000.png'],
    rating: 4.6, reviewsCount: 90, stock: 0, status: 'inactive',
  ...
  { id: 'prod35', name: 'Notebooks (Set of 3)', description: 'Spiral bound notebooks for office/study.', price: 99, category: 'cat17',
    images: ['https://placehold.co/600x450/D3D3D3/000000.png'],
    rating: 4.5, reviewsCount: 40, stock: 100, status: 'active',
  ...
  { id: 'prod36', name: 'Shampoo (Herbal)', description: 'Nourishing herbal shampoo.', price: 180, category: 'cat18',
    images: ['https://placehold.co/600x450/C1FFC1/000000.png'],
    rating: 4.7, reviewsCount: 120, stock: 60, status: 'active',
  ...
  { id: 'prod37', name: 'Drools Adult Dog Wet Food (150 g)', description: 'Nutritious dog food.', price: 40, category: 'cat19',
    images: ['https://placehold.co/600x450/FFE4C4/000000.png'],
    rating: 4.8, reviewsCount: 75, stock: 45, status: 'active',
  ...
  { id: 'prod38', name: 'Sweet Paan (Single)', description: 'Traditional sweet betel leaf preparation.', price: 20, category: 'cat20',
    images: ['https://placehold.co/600x450/90EE90/000000.png'],
    rating: 4.9, reviewsCount: 200, stock: 150, status: 'active',
  ...
  { id: 'prod39', name: 'Kellogg’s Original Corn Flakes Cereal - 500g Box', description: 'Classic crispy corn flakes, a popular breakfast choice.', price: 200, category: 'cat3',
    images: ['https://placehold.co/600x450/FFD700/000000.png'],
    rating: 4.6, reviewsCount: 150, stock: 70, status: 'active',
  ...
  { id: 'prod40', name: 'Nestlé Maggi 2-Minute Instant Masala Noodles - 70g Pack', description: 'Quick and tasty Maggi masala noodles, ready in 2 minutes.', price: 14, category: 'cat3',
    images: ['https://placehold.co/600x450/FFFF00/000000.png'],
    rating: 4.8, reviewsCount: 300, stock: 100, status: 'active',
  ...
  { id: 'prod41', name: 'Quaker Instant Oats – Nutritious Breakfast Porridge – 500g', description: 'Healthy and quick-cooking Quaker instant oats for a nutritious start.', price: 160, category: 'cat3',
    images: ['https://placehold.co/600x450/DEB887/000000.png'],
    rating: 4.7, reviewsCount: 120, stock: 60, status: 'active',
  ...
  { id: 'prod42', name: 'MTR Upma Instant Mix – South Indian Style – 200g Pouch', description: 'Authentic South Indian style Upma, ready in minutes with MTR instant mix.', price: 45, category: 'cat3',
    images: ['https://placehold.co/600x450/F5F5DC/000000.png'],
    rating: 4.5, reviewsCount: 90, stock: 50, status: 'active',
  ...
  { id: 'prod43', name: 'Safal Frozen Green Peas – Vacuum Packed – 500g', description: 'Freshly frozen green peas, vacuum packed to retain freshness.', price: 60, category: 'cat2',
    images: ['https://placehold.co/600x450/90EE90/000000.png'],
    rating: 4.6, reviewsCount: 110, stock: 80, status: 'active',
  ...
  { id: 'prod44', name: 'McCain Air-Fryer French Fries (360 g)', description: 'Classic McCain french fries, ready to fry for a crispy snack.', price: 128, category: 'cat5',
    images: ['https://placehold.co/600x450/FFEFD5/000000.png'],
    rating: 4.7, reviewsCount: 180, stock: 90, status: 'active',
  ...
  { id: 'prod45', name: 'Coca-Cola (750 ml)', description: 'Classic Coca-Cola soft drink.', price: 43, category: 'cat4',
    images: ['https://placehold.co/600x450/C00000/ffffff.png'],
    rating: 4.8, reviewsCount: 500, stock: 150, status: 'active',
  ...
  { id: 'prod46', name: 'Pepsi (750ml)', description: 'Refreshing Pepsi cola soft drink.', price: 40, category: 'cat4',
    images: ['https://placehold.co/600x450/0047AB/ffffff.png'],
    rating: 4.7, reviewsCount: 450, stock: 140, status: 'active',
  ...
  { id: 'prod47', name: 'Sprite Lime (750 ml)', description: 'Crisp lemon-lime flavored Sprite.', price: 43, category: 'cat4',
    images: ['https://placehold.co/600x450/00A86B/ffffff.png'],
    rating: 4.6, reviewsCount: 400, stock: 130, status: 'active',
  ...
  { id: 'prod48', name: 'Fanta Orange (750ml)', description: 'Bubbly orange flavored Fanta.', price: 43, category: 'cat4',
    images: ['https://placehold.co/600x450/FF8C00/ffffff.png'],
    rating: 4.5, reviewsCount: 380, stock: 120, status: 'active',
  ...
  { id: 'prod49', name: 'Thums Up (2.25L)', description: 'Strong and fizzy Thums Up cola, 2.25L pack.', price: 100, category: 'cat4',
    images: ['https://placehold.co/600x450/36454F/ffffff.png'],
    rating: 4.7, reviewsCount: 420, stock: 100, status: 'active',
  ...
  { id: 'prod50', name: 'Real Fruit Power Cranberry (1L)', description: 'Refreshing cranberry fruit juice from Real Fruit Power.', price: 119, category: 'cat4',
    images: ['https://placehold.co/600x450/DC143C/ffffff.png'],
    rating: 4.6, reviewsCount: 180, stock: 80, status: 'active',
  ...
  { id: 'prod51', name: 'Tropicana Orange Juice (1L)', description: 'Delicious Tropicana orange juice.', price: 130, category: 'cat4',
    images: ['https://placehold.co/600x450/FFA500/ffffff.png'],
    rating: 4.7, reviewsCount: 350, stock: 70, status: 'active',
  ...
  },
  {
    ...
    category: 'cat6',
    images: ['https://placehold.co/600x450/D2B48C/000000.png'],
    rating: 4.5, reviewsCount: 110, stock: 50, status: 'active',
  ...
  },
  {
    ...
    price: 30,
    category: 'cat6',
    images: ['https://placehold.co/600x450/FEFDFB/000000.png'],
    rating: 4.3, reviewsCount: 95, stock: 60, status: 'active',
  ...
  },
  {
    ...
    price: 50,
    category: 'cat1',
    images: ['https://placehold.co/600x450/FDF5E6/000000.png'],
    rating: 4.8, reviewsCount: 210, stock: 70, status: 'active',
  ...
  },
  {
    ...
    price: 20,
    category: 'cat5',
    images: ['https://placehold.co/600x450/FFDB58/000000.png'],
    rating: 4.7, reviewsCount: 350, stock: 120, status: 'active',
  ...
  },
  {
    ...
    category: 'cat5',
    images: ['https://placehold.co/600x450/FFA500/000000.png'],
    rating: 4.6, reviewsCount: 280, stock: 100, status: 'active',
  ...
  },
  {
    ...
    price: 55,
    category: 'cat5',
    images: ['https://placehold.co/600x450/F4A460/000000.png'],
    rating: 4.8, reviewsCount: 220, stock: 80, status: 'active',
  ...
  },
  {
    ...
    price: 30,
    category: 'cat5',
    images: ['https://placehold.co/600x450/FFFACD/000000.png'],
    rating: 4.5, reviewsCount: 150, stock: 90, status: 'active',
  ...
  },
  {
    ...
    price: 10,
    category: 'cat6',
    images: ['https://placehold.co/600x450/FFDEAD/000000.png'],
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E1E9F1/000000.png'], rating: 4.7, reviewsCount: 90, stock: 40, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E2EAF2/000000.png'], rating: 4.5, reviewsCount: 75, stock: 55, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E3EBF3/000000.png'], rating: 4.6, reviewsCount: 85, stock: 45, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E4ECF4/000000.png'], rating: 4.6, reviewsCount: 82, stock: 48, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E5EDF5/000000.png'], rating: 4.7, reviewsCount: 100, stock: 30, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E6EEF6/000000.png'], rating: 4.8, reviewsCount: 70, stock: 25, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E7EFF7/000000.png'], rating: 4.5, reviewsCount: 60, stock: 35, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E8F0F8/000000.png'], rating: 4.4, reviewsCount: 50, stock: 40, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E9F1F9/000000.png'], rating: 4.6, reviewsCount: 95, stock: 28, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/C10000/ffffff.png'], rating: 4.8, reviewsCount: 180, stock: 100, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/C20000/ffffff.png'], rating: 4.7, reviewsCount: 150, stock: 80, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/404D57/ffffff.png'], rating: 4.6, reviewsCount: 100, stock: 60, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/3EB489/000000.png'], rating: 4.5, reviewsCount: 120, stock: 70, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/2C2C2C/ffffff.png'], rating: 4.7, reviewsCount: 140, stock: 90, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/D3D3D3/000000.png'], rating: 4.6, reviewsCount: 130, stock: 85, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/E21329/ffffff.png'], rating: 4.7, reviewsCount: 160, stock: 95, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/FFC300/000000.png'], rating: 4.8, reviewsCount: 200, stock: 110, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/FF7F50/ffffff.png'], rating: 4.5, reviewsCount: 90, stock: 60, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/FED8B1/000000.png'], rating: 4.6, reviewsCount: 80, stock: 55, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/C25A7C/ffffff.png'], rating: 4.7, reviewsCount: 110, stock: 75, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/DAA520/ffffff.png'], rating: 4.8, reviewsCount: 90, stock: 50, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/ADD8E6/000000.png'], rating: 4.7, reviewsCount: 85, stock: 45, status: 'active',
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x450/F0F8FF/000000.png'], rating: 4.6, reviewsCount: 150, stock: 120, status: 'active',
...
export const mockOrders: Order[] = [
  {
    ...
    userId: 'user123',
    items: [
      { productId: 'prod1', name: 'Apples (Shimla)', quantity: 1, price: 120, imageUrl: mockProducts.find(p=>p.id==='prod1')?.images[0] },
      { productId: 'prod4', name: 'Whole Milk (1L)', quantity: 2, price: 65, imageUrl: mockProducts.find(p=>p.id==='prod4')?.images[0] },
    ],
  ...
  },
  {
    ...
    userId: 'user123',
    items: [
      { productId: 'prod6', name: 'Potato Chips (Salted)', quantity: 3, price: 20, imageUrl: mockProducts.find(p=>p.id==='prod6')?.images[0] },
    ],
  ...
  },
   {
    ...
    userId: 'user123',
    items: [
      { productId: 'prod2', name: 'Bananas (Robusta)', quantity: 1, price: 40, imageUrl: mockProducts.find(p=>p.id==='prod2')?.images[0] },
      { productId: 'prod5', name: 'Zero Maida Whole-Wheat Bread', quantity: 1, price: 52, imageUrl: mockProducts.find(p=>p.id==='prod5')?.images[0] },
    ],
...
export const mockPromoCodesData: PromoCode[] = [
  { id: 'promo1', code: 'SAVE20', discountType: 'percentage', value: 20, minOrderValue: 199, expiresAt: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString(), status: 'active', description: 'Get 20% off on orders above ₹199' },
  { id: 'promo2', code: 'FLAT50', discountType: 'fixed', value: 50, minOrderValue: 299, expiresAt: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000).toISOString(), status: 'active', description: 'Flat ₹50 off on orders above ₹299' },
  { id: 'promo3', code: 'FREEDEL', discountType: 'fixed', value: 50, // Assuming standard delivery is 50
